export const mockData = {
  boards: [
    ...
    // --- BOARD GIẢ LẬP SỐ 2 (Rỗng để test) ---
    {
      _id: 'board-id-02',
      title: 'ReactJS Learning Board',
      description: 'Học ReactJS cơ bản đến nâng cao',
      type: 'public',
      ownerIds: [],
      memberIds: [],
      columnOrderIds: [],
    ...
    // --- BOARD GIẢ LẬP SỐ 3 (Rỗng để test) ---
    {
      _id: 'board-id-03',
      title: 'Công việc hàng ngày',
      description: 'Theo dõi task hằng ngày',
      type: 'private',
      ownerIds: [],
      memberIds: [],
      columnOrderIds: [],
